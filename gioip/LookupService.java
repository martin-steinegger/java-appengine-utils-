...
public class LookupService {
	 ...
	 * Database file.
	 */
	private SeekableInputStream file = null;
	 ...
	 *             database file.
	 */
	public LookupService(byte[]  databaseFile, int options) throws IOException {
		this.file = new SeekableInputStream(databaseFile);
		dboptions = options;
		init();
	}
